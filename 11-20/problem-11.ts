...
(() => {
  ...
  const returnProductOfFourNumbersInSameCol = (row: number, col: number) => {
    let result =
      matrix[row][col] *
      matrix[row + 1][col] *
      matrix[row + 2][col] *
  ...
  const returnProductOfFourNumbersInSameRow = (row: number, col: number) => {
    let result =
      matrix[row][col] *
      matrix[row][col + 1] *
      matrix[row][col + 2] *
  ...
  const returnProductOfFourNumbersInDiagonal = (row: number, col: number) => {
    let result =
      matrix[row][col] *
      matrix[row + 1][col + 1] *
      matrix[row + 2][col + 2] *
  ...
  const returnProductOfFourNumbersInInverseDiagonal = (row: number, col: number) => {
    let result =
      matrix[row][col] *
      matrix[row + 1][col - 1] *
      matrix[row + 2][col - 2] *
  ...
  const calculateAllDiagonals = (): void => {
  ...
  const calculateAllInverseDiagonals = (): void => {
